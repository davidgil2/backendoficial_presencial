CREATE TABLE IDENTIFICATION_TYPE (
    IDENTIFICATION_TYPE_ID INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    IDENTIFICATION_TYPE VARCHAR(255) NOT NULL
);
SELECT * FROM C##AUTHB.PERSON;
CREATE TABLE PERSON (
...
CREATE TABLE PERSON_POSITION (
    PERSON_POSITION_ID INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE POSITION_PRIVILEGE (
    POSITION_PRIVILEGE_ID INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    POSITION_ID INTEGER NOT NULL,
