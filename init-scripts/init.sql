...
CREATE TABLE
  FLIGHT (
    ...
    flight_type NUMBER (1) NOT NULL CHECK (flight_type IN (0, 1)), -- 0: Domestic, 1: International
...
CREATE TABLE
  AIRPLANE_MODEL (
    ...
    capacity NUMBER (3) CHECK (capacity > 0) NOT NULL, -- Number of passengers
    cargo_capacity NUMBER (10, 2) CHECK (cargo_capacity > 0) NOT NULL, -- In tons
    volume_capacity NUMBER (10, 2) CHECK (volume_capacity > 0) NOT NULL -- In cubic meters
  );
...
CREATE TABLE
  AIRPORT (
    ...
    type NUMBER (1) NOT NULL CHECK (type IN (0, 1)), -- 0: Domestic, 1: International
    city VARCHAR2 (80) NOT NULL,
    country VARCHAR2 (30) NOT NULL,
    runways NUMBER (2) NOT NULL CHECK (
      runways > 0
      AND runways < 15
    )
  );
...
CREATE TABLE
  SCALE (
    ...
    airplane_model VARCHAR2 (15) REFERENCES AIRPLANE_MODEL (airplane_model),
